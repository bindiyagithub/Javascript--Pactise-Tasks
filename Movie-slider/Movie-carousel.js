...
const myhtml = movies.map(function(value,index) {

       // for button (Indecators display) display using map
     let myButton  = value.Images.map(function(valuebutton,indexbutton) {
 
         return(`<button type="button"
          data-bs-target="#demo${index}"
           data-bs-slide-to="${indexbutton}"
            class="active"></button>`)
     })
 
     // for array of images display using map
     let myimages = value.Images.map(function(valueimage,imageindex) {
 
         return(`<div class="carousel-item active">
         <img src="${valueimage}" alt="Los Angeles" 
         class="d-block" style="width:100%">
        </div>`)
 
     })
 
     // 1st display data of movie json 
     return(`<div id="demo${index}" class="carousel slide" 
